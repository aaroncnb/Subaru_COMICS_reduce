...
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A01.DAT

q_arith COMQ_NL_OBJ_A02_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A02.DAT

q_arith COMQ_NL_OBJ_A03_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A03.DAT

q_arith COMQ_NL_OBJ_A04_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A04.DAT

q_arith COMQ_NL_OBJ_A05_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A05.DAT

q_arith COMQ_NL_OBJ_A06_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A06.DAT

q_arith COMQ_NL_OBJ_A07_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A07.DAT

q_arith COMQ_NL_OBJ_A08_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A08.DAT

q_arith COMQ_NL_OBJ_A09_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A09.DAT

q_arith COMQ_NL_OBJ_A10_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A10.DAT

q_arith COMQ_NL_OBJ_A11_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A11.DAT

q_arith COMQ_NL_OBJ_A12_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A12.DAT

q_arith COMQ_NL_OBJ_A13_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A13.DAT

q_arith COMQ_NL_OBJ_A14_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A14.DAT

q_arith COMQ_NL_OBJ_A15_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A15.DAT

q_arith COMQ_NL_OBJ_A16_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_A16.DAT


########Object B:

q_arith COMQ_NL_OBJ_B01_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194  1| awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B01.DAT

q_arith COMQ_NL_OBJ_B02_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B02.DAT

q_arith COMQ_NL_OBJ_B03_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B03.DAT

q_arith COMQ_NL_OBJ_B04_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B04.DAT

q_arith COMQ_NL_OBJ_B05_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B05.DAT

q_arith COMQ_NL_OBJ_B06_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B06.DAT

q_arith COMQ_NL_OBJ_B07_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B07.DAT

q_arith COMQ_NL_OBJ_B08_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B08.DAT

q_arith COMQ_NL_OBJ_B09_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B09.DAT

q_arith COMQ_NL_OBJ_B10_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B10.DAT

q_arith COMQ_NL_OBJ_B11_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B11.DAT

q_arith COMQ_NL_OBJ_B12_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B12.DAT

q_arith COMQ_NL_OBJ_B13_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B13.DAT

q_arith COMQ_NL_OBJ_B14_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B14.DAT

q_arith COMQ_NL_OBJ_B15_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B15.DAT

q_arith COMQ_NL_OBJ_B16_NC.fits / 100.0 SCALE1
q_startrace SCALE1 1 1-320 170:194 1 | awk '{print $2,$10}' > SPATIAL_CONST_OBJ_B16.DAT
