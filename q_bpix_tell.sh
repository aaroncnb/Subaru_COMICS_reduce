...
q_list_stat TEST_S2tell_MED.fits 1 1-320 1:5 1 | awk '{print $2,$5}' > SKY_RES_S2.TXT
g77 -o test SKY_RES_S2.f
./test
q_mkimg SKY_RES_MAP_S2.TXT SKY_RES_MAP_S2.fits 320 240
